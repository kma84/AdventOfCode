...
namespace dia19
{
    internal class V4
    {
        ...
        private static readonly List<string> ROTATIONS = new() {
                "(x,y,z)",
                "(x,y,-z)",
                "(x,-y,z)",
                "(x,-y,-z)",
        ...
        private static string input = "inputTest2.txt"; // "input.txt" "inputTest.txt" "inputTest2.txt"
        ...
        private static List<(int x, int y, int z)> GetPointsRelativeToA(
            Scanner scannerA, Scanner scannerB, (int x, int y, int z) pointA, (int x, int y, int z) pointB, string rotation)
        {
